  ...
  return (
    <div className="borderStyle SideBar position-relative">
      ...
      <div className="p-4 ">
        ...
        <MenuItem menuName="Dashboard" url="/" fontAws="fa-solid fa-house" className="text-decoration-none " />
        <MenuItem menuName="Wallet"  url="/Wallet" fontAws="fas fa-wallet" />
        <MenuItem menuName="Statistics" url="/statistics" fontAws="fa-solid fa-chart-simple" />
        ...
        />
        <MenuItem menuName="News" url="/News"  fontAws="fa-solid fa-newspaper" />
    </div>
    <hr/>
